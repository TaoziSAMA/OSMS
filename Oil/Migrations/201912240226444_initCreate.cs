    ...
    public partial class initCreate : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        LoginTime = c.DateTime(precision: 0, storeType: "datetime2"),
                    })
                .PrimaryKey(t => t.Id)
            ...
            CreateTable(
                ...
                c => new
                    {
                        ...
                        Sex = c.Boolean(nullable: false),
                        IsDel = c.Boolean(nullable: false),
                        NeedExec = c.String(nullable: false, maxLength: 1, unicode: false),
                        Discrible = c.String(nullable: false, maxLength: 1, unicode: false),
                        BirthDay = c.DateTime(storeType: "date"),
                        MaritalStatus = c.Boolean(),
                        Height = c.Decimal(precision: 5, scale: 2),
                        HighestEducation = c.Int(),
                ...
                .PrimaryKey(t => new { t.Id, t.StaffName, t.Sex, t.IsDel, t.NeedExec, t.Discrible });
            
            CreateTable(
                "dbo.View_LeaveOfficeJ",
                c => new
                    {
                        Id = c.Guid(nullable: false),
                        JobId = c.Guid(nullable: false),
                ...
                .PrimaryKey(t => new { t.Id, t.JobId, t.NeedExec, t.Discrible });
            
            CreateTable(
                "dbo.View_OilMaterialOrderSP",
                c => new
                    {
                        Id = c.Guid(nullable: false),
                        No = c.String(nullable: false, maxLength: 100),
                        ...
                        CreateTime = c.DateTime(),
                        UpdateTime = c.DateTime(),
                        StaffName = c.String(maxLength: 500),
                    })
                .PrimaryKey(t => new { t.Id, t.No, t.ApplyPersonId, t.IsDel, t.NeedExec, t.Discrible });
                ...
                c => new
                    {
                        ...
                        JobUpdateTime = c.DateTime(),
                        JobCreateTime = c.DateTime(),
                        JobIsDel = c.Boolean(),
                    })
                .PrimaryKey(t => t.Id);
        ...
        {
            DropForeignKey("dbo.LoginInfo", "StaffId", "dbo.Staff");
            DropIndex("dbo.LoginInfo", new[] { "StaffId" });
            DropTable("dbo.View_StaffJ");
            DropTable("dbo.View_OilMaterialOrderSP");
            DropTable("dbo.View_LeaveOfficeJ");
            DropTable("dbo.View_Entry");
